          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation" style="margin-left: 60px;">
              <ul class="site-menu js-clone-nav d-none d-lg-block font-weight-bold">
                ...
                <!--<li class="has-children">
                  ...
                  <ul class="dropdown">
                    <li class="has-children">
                      <a href="#">Hay Fever</a>
                      <ul class="dropdown">
                        <li><a href="#">Avamys</a></li>
                        <li><a href="#">Dymista</a></li>
                        <li><a href="#">Levocetirizine</a></li>
                      </ul>
                    </li>
                    <li class="has-children">
                      ...
                      <ul class="dropdown">
                        ...
                        <li><a href="Atovaquone.html">Atovaquone/Proguanil</a></li>
                        <li><a href="#"></a></li>
                      </ul>
                    </li>
                    <li class="has-children">
                      ...
                      <ul class="dropdown">
                        <li><a href="duac.html">Duac</a></li>
                        <li><a href="skinoren.html">Skinoren</a></li>
                        <li><a href="Tetralysal.html">Tetralysal</a></li>
                        <li><a href="Isotrex.html">Isotrex</a></li>
                      </ul>
                    </li>
                ...
                <li><a href="Login/index.html" class=""><i class="icon-user" style="color: green; font-size:25px;"></i> <i style="font-size:25px; font-style:"> &nbsp; LOG IN </i></a></li>
              </ul>
            </nav>
          </div>
